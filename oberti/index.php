<?php
    ...
    if($_SESSION['ruolo'] == 'dipendente'){
        ...
        echo "<a href='richiesteDipendente.php'>Storico delle tue richieste</a><br><br>";
    ...
    if($_SESSION['ruolo'] == 'amministratore'){
        ...
        echo "<a href='registraCellulare.php'>Regsitra un nuovo cellulare</a><br<<br>";
        echo "<p> Ruolo: {$_SESSION['ruolo']}</p>";
        echo "</body>";
        echo "</html>";
        exit;
    ...
    if($_SESSION['ruolo'] == 'manutentore'){
        ...
        echo "<a href='profilo.php'>Visualizza il tuo profilo</a><br><br>";
        echo "<a href='visualizzaRichieste.php'>Visualizza tutte le  richieste </a><br><br>";
        echo "<a href='visualizzaRichiesteManutentore.php'>Gestisci le tue richieste </a><br><br>";
        echo "<p> Ruolo: {$_SESSION['ruolo']}</p>";
        echo "</body>";
        echo "</html>";
        exit;
